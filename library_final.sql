...
-- Χρόνος δημιουργίας: 30 Μάη 2023 στις 17:59:50
...
(1, '2o pefkis', '1111111111111', 3),
(2, '5o hrakleiou', '1111111111111', -1),
(3, '5o hrakleiou', '2222222222222', 2),
(4, '5o hrakleiou', '0000000000000', 1);
...
('0000000000000', 'To Kill a Mockingbird', 'Harper Perennial Modern Classics', 324, 'he 1930s in the fictional town of Maycomb, Alabama, it follows the story of Scout Finch as she navigates issues of racial inequality, injustice, and morality. Through the perspective of Scout, the nov', 1, '[Image URL or file path]', 'English'),
('1111111111111', 'The Great Gatsby', 'Scribner', 218, 'hello', 2, '[Image URL or file path]', 'English'),
('2222222222222', 'programming in unix', 'kleidarithmos', 768, 'programming on unix', 2, 'link', 'greek');
...
(99, 981, '1111111111111', '2023-05-28', 'returned'),
(100, 980, '2222222222222', '2023-05-30', 'returned'),
(101, 980, '1111111111111', '2023-05-30', 'active'),
(102, 981, '1111111111111', '2023-05-30', 'active'),
(103, 123, '1111111111111', '2023-05-30', 'active');
...
(52, '161809', 'pavlos skou', 45, '6947177115', 'pavlos.skou@gmail.com', 1, 1, NULL, 2, 2),
(100, '', 'el pap', 35, '6947854313', 'elpap@gmail.com', 0, 2, NULL, 1, 1),
(123, '', 'john pap', 15, '2102856010', 'johnpap@gmail.com', 1, 1, NULL, 1, 2),
...
(980, '', 'areti mei', 14, '6976542313', 'aretimei@gmail.com', 5, 1, NULL, 0, 2),
(981, '', 'Dhm seferiadi', 34, '6984315621', 'dhm.seferiadi@gmail.com', 6, 1, NULL, 1, 2),
...
--
ALTER TABLE `goes_to`
  MODIFY `goes_to_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

...
-- Χρόνος δημιουργίας: 25 Μάη 2023 στις 21:46:45
...
DROP SCHEMA IF EXISTS library_github_new;
CREATE SCHEMA library_github_new;
USE library_github_new;
...
--
ALTER TABLE `goes_to`
  MODIFY `goes_to_id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `belongs_to`
  ...
  ADD CONSTRAINT `belongs_to_ibfk_2` FOREIGN KEY (`id`) REFERENCES `user` (`id`);

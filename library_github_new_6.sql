...
-- Χρόνος δημιουργίας: 29 Μάη 2023 στις 10:27:58
...
DROP SCHEMA IF EXISTS library_github_new_6;
CREATE SCHEMA library_github_new_6;
USE library_github_new_6;
...
('1111111111111', 'The Great Gatsby', 'Scribner', 218, 'hello', 7, '[Image URL or file path]', 'English'),
...
(82, 52, '1111111111111', '2023-05-18', 'delayed'),
...
(980, '', 'areti mei', 14, '6976542313', 'aretimei@gmail.com', 2, 1, NULL, 2, 2),
...
--
ALTER TABLE `book_key_words`
  MODIFY `book_key_word_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `key_word`
  MODIFY `key_word_id` int(11) NOT NULL AUTO_INCREMENT;
